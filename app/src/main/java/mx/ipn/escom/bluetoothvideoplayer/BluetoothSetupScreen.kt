...
fun BluetoothSetupScreen(
    ...
    var receivedMessage by
    rememberSaveable(role.name) {
        mutableStateOf("")
    }

    var connectionActive by
    rememberSaveable(role.name) {
        mutableStateOf(false)
    }
